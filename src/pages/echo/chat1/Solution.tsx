...
const Solution = () => (
  <Card className='correctCard'>
    <CardBody>
      ...
      <p>Determine what the bats have to do with the blackmail notes.  Detective Holt suggests going to the library to find out more information.</p>
     
      <p>
        <Link to={`/${ROUTES.ECHO.route}/2`} className='btn btn-primary'>
          Go to the library
        </Link>
      </p>
    </CardBody>
